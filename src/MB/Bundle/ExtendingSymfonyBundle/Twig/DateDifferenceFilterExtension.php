...
class DateDifferenceFilterExtension extends Twig_Extension
{
	/**
	 * {@inheritDoc}
	 */
	...
	{
		return [
			new Twig_SimpleFilter('to_date_string', [$this, 'toDateString']),
		];
	}
	 ...
	 * @return string
	 */
	public function toDateString(DateTime $date)
	{
